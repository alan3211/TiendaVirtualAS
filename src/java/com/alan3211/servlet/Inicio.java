...
public class Inicio extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("te xt/html;charset = UTF-8");
        ...
        out.println("<!DOCTYPE html>\n"
                ...
                + "                    <img src=\"./img/tienda.jpg\" alt=\"WAD-Store\" class=\"img-thumbnail center-block\"/>\n"
                + "                </article>\n"
                + "                <aside class=\"col-xs-12  col-sm-4 col-md-3 col-lg-6\">\n"
                + "                    <p class=\"lead text-left\">WAD-Store es una tienda que te proporcionalos articulos que hoy en día estan de moda\n"
